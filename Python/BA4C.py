...
def Cyclospectrum(peptide):
    amino='''G A S P V T C I L N D K Q E M H F R Y W'''.split()
    masses='''57 71 87 97 99 101 103 113 113 114 115 128 128 129 131 137 147 156 163 186'''.split()
    subPeptides=['',peptide]
    ...
    for pep in subPeptides:
        mass=0
        for a in pep:
            mass=mass+int(masses[amino.index(a)])
